...
public class ApiAutomationExample {
    public static void main(String[] args) {
        ...
        // Automated Get request to verify status code a specific field in the response
        Response response = given()
                ...
                .body("title", equalTo("sunt aut facere repellat provident occaecati excepturi optio reprehenderit"))  //verify title field
                .extract()
                .response();
